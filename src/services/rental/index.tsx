...
export function useCreateLocacaoMutation(): UseMutationResult<
  LocacaoInterface,
  Error,
  CreateLocacaoInterface
> {
...
export function useUpdateLocacaoMutation(): UseMutationResult<
  LocacaoInterface,
  Error,
  { id: string; payload: UpdateLocacaoInterface }
> {
  const queryClient = useQueryClient();
